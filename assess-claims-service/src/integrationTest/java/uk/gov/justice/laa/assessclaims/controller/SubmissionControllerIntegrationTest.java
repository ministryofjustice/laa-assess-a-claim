...
import uk.gov.justice.laa.assessaclaim.AssessClaimsApplication;
import uk.gov.justice.laa.assessaclaim.security.TestSecurityConfig;

@SpringBootTest(classes = AssessClaimsApplication.class)
