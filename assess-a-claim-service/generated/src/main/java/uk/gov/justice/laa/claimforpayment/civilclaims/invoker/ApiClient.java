...
package uk.gov.justice.laa.assessaclaim.civilclaims.invoker;
...
import uk.gov.justice.laa.assessaclaim.civilclaims.invoker.auth.Authentication;
import uk.gov.justice.laa.assessaclaim.civilclaims.invoker.auth.HttpBasicAuth;
import uk.gov.justice.laa.assessaclaim.civilclaims.invoker.auth.HttpBearerAuth;
import uk.gov.justice.laa.assessaclaim.civilclaims.invoker.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://laa-data-stewardship-payments-dev.apps.live.cloud-platform.service.justice.gov.uk";
